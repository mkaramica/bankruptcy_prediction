...
```{r showFeatureVariation1, fig.cap="Box Plots of Features of Bankruptcy Database: Features #1 to #46", fig.number=TRUE, echo=FALSE, message = FALSE, fig.height = 8 }
...
```{r showFeatureVariation2, fig.cap="Box Plots of Features of Bankruptcy Database: Features #47 to #94", fig.number=TRUE, echo=FALSE, message = FALSE, fig.height = 8 }
...
```{r show2DPlotsOfPOD, fig.cap="Original Database: Features with the Highest Standatd Deviation", fig.number=TRUE, echo=FALSE, fig.height = 8 }
